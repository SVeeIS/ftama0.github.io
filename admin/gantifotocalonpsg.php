...
if(isset($_POST['update'])){
	...
	echo "<script type='text/javascript'>
			...
			document.location = 'calonpsgedit.php?id=$id'; 
		</script>";
}
?>
			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h2 class="page-title">Foto Pasangan Calon</h2>

						<div class="row">
							<div class="col-md-10">
								<div class="panel panel-default">
									<div class="panel-heading">Detail Foto Pasangan Calon</div>
									<div class="panel-body">
										<form method="post" class="form-horizontal" enctype="multipart/form-data">
											...
											<label class="col-sm-4 control-label">Foto Sekarang</label>
												<?php 
												$id=intval($_GET['no_urut']);
												$sql ="SELECT foto_pasangan_calon from calon where no_urut='$id'";
												$query	= mysqli_query($koneksidb, $sql);
												$cnt=1;
