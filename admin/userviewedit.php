...
<form id="theform" data-parsley-validate class="form-horizontal form-label-left" action="<?php $_SERVER['PHP_SELF']; ?>" method="post" enctype="multipart/form-data">
	...
	<div class="form-group">
		<label class="control-label col-md-3 col-sm-3 col-xs-12" for="nama">Foto dengan KTM</label>
			<div class="col-md-6 col-sm-6 col-xs-12">
				<img src="img/calon/<?php echo htmlentities($result['foto_user']);?>" width="200" height="150">
			</div>
	</div>
	<div class="form-group">
		<label class="control-label col-md-3 col-sm-3 col-xs-12" for="nama">Foto KTM</label>
			<div class="col-md-6 col-sm-6 col-xs-12">
				<img src="img/calon/<?php echo htmlentities($result['foto_ktm']);?>" width="200" height="150">
			</div>
	</div>
	</form>
	<div class="modal-footer">
    <button class="btn btn-default berhasil" onclick="window.location.href='userstatus.php?id=<?php echo $Kode;?>&status=Verifikasi+Berhasil'">Verifikasi Berhasil</button>
    <button class="btn btn-default gagal" onclick="window.location.href='userstatus.php?id=<?php echo $Kode;?>&status=Verifikasi+Gagal'">Verifikasi Gagal</button>
