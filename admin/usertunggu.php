...
<body>
			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h2 class="page-title">Kelola User Menunggu Verifikasi</h2>
						
						<!-- Zero Configuration Table -->
						<div class="panel panel-default">
							<div class="panel-heading">Daftar User Menunggu Verifikasi</div>
							...
							<?php if($error){?><div class="errorWrap"><strong>ERROR</strong>:<?php echo htmlentities($error); ?> </div><?php } 
								...
								<table id="zctb" class="display table table-striped table-bordered table-hover" cellspacing="0" width="100%">
									...
									<?php
										$i=0;
										$sqluser = "SELECT * FROM user WHERE status_registrasi='Menunggu Verifikasi'";
	...
	<script>
		...
		$('[data-load-code]').on('click',function(e) {
					...
					if(code) {
						$($this.data('remote-target')).load('userviewedit.php?code='+code);
						app.code = code;
